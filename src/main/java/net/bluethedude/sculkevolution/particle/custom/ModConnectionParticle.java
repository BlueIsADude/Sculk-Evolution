package net.bluethedude.sculkevolution.particle.custom;
...
public class ModConnectionParticle extends SpriteBillboardParticle {
    ...
    ModConnectionParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
        this(clientWorld, d, e, f, g, h, i, false, Particle.DynamicAlpha.OPAQUE);
    }

    ModConnectionParticle(
            ClientWorld world,
            double x,
            double y,
            double z,
    ...
    @Environment(EnvType.CLIENT)
    public static class UmbraVaultConnectionFactory implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public UmbraVaultConnectionFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ModConnectionParticle connectionParticle = new ModConnectionParticle(clientWorld, d, e, f, g, h, i, true, new Particle.DynamicAlpha(0.0F, 0.6F, 0.25F, 1.0F));
