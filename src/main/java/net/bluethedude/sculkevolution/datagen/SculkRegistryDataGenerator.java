...
public class SculkRegistryDataGenerator extends FabricDynamicRegistryProvider {
    public SculkRegistryDataGenerator(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
